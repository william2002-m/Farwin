...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("JioSavaan/assets/JioSavaanl2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('JioSavaan/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('JioSavaan/assets/font.ttf', size=60)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "JioSavaan/assets/JioSavaanl2.png"
